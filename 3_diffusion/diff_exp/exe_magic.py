...
from dataset_magic import get_dataloader

parser = argparse.ArgumentParser(description="TabCSDI")
parser.add_argument("--config", type=str, default="magic.yaml")
...
foldername = "./save/magic_fold" + str(args.nfold) + "_" + current_time + "/"
